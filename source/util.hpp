...
const std::array<Color, 7> colors{Colors::I, Colors::O, Colors::L, Colors::J, Colors::S, Colors::T, Colors::Z};
const std::array<Color, 7> colorsGhost{Colors::IGhost, Colors::OGhost, Colors::LGhost, Colors::JGhost, Colors::SGhost, Colors::TGhost, Colors::ZGhost};

static void straightLine(float x, float y, float w, float h, float thick, Color col) {
