...
MainMenu::MainMenu()
    : State(),
      gui(BSCREEN_WIDTH, BSCREEN_HEIGHT, C2D_Color32(100, 100, 100, 255),
          C2D_Color32(0, 0, 0, 255), C2D_Color32(50, 50, 50, 255)) {
...
void MainMenu::draw(bool bottom) {
	if (!bottom) {
        ...
        C2D_DrawText(
            &titleText, C2D_WithColor, SCREEN_WIDTH / 2.0f - textW / 2.0f,
            SCREEN_HEIGHT / 2.0f - textH / 2.0f, 0, 1, 1, titleTextColor);
	} else {
